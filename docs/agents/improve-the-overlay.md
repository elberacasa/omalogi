...
```text
Read docs/agents/agent-guide.md, especially "Working on the overlay", first and follow its rules.
...
4. Run every check in docs/agents/agent-guide.md, including qmllint on the files you changed.
